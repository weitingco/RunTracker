	...
	*/
	private static class RunListCursorLoader extends SQLiteCursorLoader{
		...
		protected Cursor loadCursor(){
			...
			Cursor cursor = RunManager.get(getContext()).queryRuns();
			return cursor;
		}
	}
	...
	*/
	...
	private static class RunCursorAdapter extends CursorAdapter{
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			TextView title = (TextView)view.findViewById(R.id.list_item_run_title);
			title.setText(String.valueOf(run.getId()));
			...
			date.setText("Run starts from:"+
					DateFormat.format(dateFormat, run.getStartDate()));
			CheckBox check = (CheckBox)view.findViewById(R.id.list_item_current_run);
			check.setChecked(trackingThisRun);
		}
		...
		public View newView(Context context, Cursor cursor, ViewGroup parent) {
			...
			return inflater.inflate(R.layout.list_item_run, parent, false);
		}
	}
	*/
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		Loader<Cursor> loader = new RunListCursorLoader(getActivity());
		return loader;
	}
